...
const Phishing = () => {
  ...
  const preferredKey = "phishingAttack";
  ...
  const tabItems = [
    {
      ...
      path: "/internal/phishing",
    },
    {
      key: "data exploitation",
      label: "Data Exploitation",
      category: "Internal Attacks",
      path: "/internal/data-exploitation",
    },
    {
      key: "lateral movement",
      label: "Lateral Movement",
      category: "Internal Attacks",
      path: "/internal/lateral-movement",
    },
    {
      key: "dos attack",
      label: "DoS Attack",
      category: "Internal Attacks",
      path: "/internal/dos-attack",
    },
  ];
        ...
        <Layout>
          ...
          <Content style={{ marginTop: "1px" }}>
            <div className="terminal-controls" style={{ marginBottom: "16px" }}>
              ...
              >
                {loading ? "Attacking..." : "Phishing Attack"}
              </button>
            </div>
          </Content>
        </Layout>
