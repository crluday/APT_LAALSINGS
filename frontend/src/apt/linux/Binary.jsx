...
const Binary = ({
  ...
  description = "Uses a generated for executable.",
  onClose,
}) => {
          ...
          <Content style={{ marginTop: "1px" }}>
            ...
            <Form
              ...
              initialValues={{
                ...
                commType: "linux/x64/meterpreter/reverse_tcp",
                arch: "elf",
              }}
            >
                ...
                <Form.Item label="Payload" name="commType" required>
                  <Select>
                    <Select.Option value="linux/x64/meterpreter/reverse_tcp">linux/x64/meterpreter/reverse_tcp</Select.Option>
