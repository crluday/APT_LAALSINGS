...
const Shinstall = ({
  payloadType = "Linux Installer",
  description = "Uses Linux Installer to launch a Grunt using ",
  onClose,
}) => {
        ...
        <Layout>
          <Content style={{ marginTop: "1px" }}>
            ...
            <Form
              ...
              initialValues={{
                platform: "linux",
                commType: "cmd/unix/reverse_bash",
                arch: "raw",
              }}
            >
            ...
            <Select>
            <Select.Option value="cmd/unix/reverse_bash">cmd/unix/reverse_bash</Select.Option>
            {/* <Select.Option value="linux/x86/meterpreter/reverse_tcp">linux/x86/meterpreter/reverse_tcp</Select.Option> */}
