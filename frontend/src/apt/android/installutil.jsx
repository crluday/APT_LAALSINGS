...
const InstallutilLauncher = ({
  payloadType = "Installutil",
  description = "Uses installutil.exe to start a Grunt via Uninstall method.",
  onClose,
}) => {
...
export default InstallutilLauncher;
