...
const backendUrl = document.location.host+":3001"


const WscriptLauncher = ({
  payloadType = "Wscript",
  description = "Uses wscript.exe to launch a Grunt using a COM activated Delegate and ActiveXObjects (ala DotNetToJScript). Please note that DotNetToJScript-based launchers may not work on Windows 10 and Windows Server 2016.",
  onClose,
}) => {
...
export default WscriptLauncher;
