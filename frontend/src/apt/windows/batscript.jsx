...
const BatLauncher = ({
  payloadType = "BatLauncher",
  description = "Uses BatLauncher to launch a Grunt using ",
  onClose,
}) => {
          ...
          <Content style={{ marginTop: "1px" }}>
            ...
            >
              ...
              <Form
                ...
                initialValues={{
                  platform:"Windows",
                  commType: "cmd/windows/reverse_powershell",
                  arch: "raw",
                }}
              >
                ...
                <Form.Item label="Platform" name="platform" required>
                <Select>
                ...
                <Form.Item label="Payload" name="commType" required>
                  <Select>
                    <Select.Option value="windows/meterpreter/reverse_tcp">windows/meterpreter/reverse_tcp</Select.Option>
                    <Select.Option value="windows/x64/meterpreter/reverse_tcp">windows/x64/meterpreter/reverse_tcp</Select.Option>
                    <Select.Option value="cmd/windows/reverse_powershell">cmd/windows/reverse_powershell</Select.Option>
                    <Select.Option value="windows/shell/reverse_tcp">windows/shell/reverse_tcp</Select.Option>
                  </Select>
                </Form.Item>
                ...
                {/* <Form.Item label="Encoder" name="encoder">
                  <Select>
                    ...
                    <Select.Option value="x86/shikata_ga_nai">
                      x86/Shikata_Ga_Ni
                    </Select.Option>
                    <Select.Option value="cmd/powershell_base64 ">
                 ...
                 <Form.Item label="Iteration" name="Iter" >
